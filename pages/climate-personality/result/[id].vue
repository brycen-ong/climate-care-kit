    ...
    <div class="container">
      ...
      <div class="flex justify-around w-full mb-16">
        <div class="w-80 flex flex-col items-center justify-center text-center" v-if="results[result]?.risks?.['extreme-heat']">
          <img class="h-32 w-32" src="/assets/images/extreme-heat-icon.png">
        ...
        <div class="w-80 flex flex-col items-center justify-center text-center" v-if="results[result]?.risks?.['rain-and-flooding']">
          <img class="h-32 w-32" src="/assets/images/rain-icon.png">
        ...
        <div class="w-80 flex flex-col items-center justify-center text-center" v-if="results[result]?.risks?.['air-pollution']">
          <img class="h-32" src="/assets/images/air-pollution-icon.png">
  ...
  <section class="section">
    <div class="container">
      ...
      <div class="flex gap-8 mb-64">
        ...
        <img class="h-139 w-139" src="/assets/images/result-extreme-heat-image.png">
      </div>
      <div class="flex gap-8 mb-64">
        <div>
        ...
        <img class="h-139 w-139" src="/assets/images/result-rain-image.png">
      </div>
      <div class="flex gap-8 mb-32">
        ...
        <img class="h-139 w-139" src="/assets/images/result-air-pollution-mage.png">
      </div>
    </div>
  </section>
  <section class="section">
    <div class="container">
      ...
      <img class="h-50 w-50 mb-4" src="/assets/images/sustainable-icon.png">
      ...
      <img class="h-50 w-50 mb-4" src="/assets/images/green-icon.png">
      ...
      <img class="h-50 w-50 mb-4" src="/assets/images/brain-icon.png">
